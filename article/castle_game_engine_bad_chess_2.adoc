...
- Dynamically enabling / disabling a shader effect. This means adding `TEffectNode` and `TEffectPartNode` nodes to the scene and implementing the effect using GLSL (_OpenGL Shading Language_). See `https://castle-engine.io/shaders` about this.
